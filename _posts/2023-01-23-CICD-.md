...
#### **흐름**  
1. 브랜치 생성  
![img_27.png](./images/cicd/img_27.png)  
...
2. 커밋 & 푸쉬 
![img_28.png](./images/cicd/img_28.png)  
...
![img_29.png](./images/cicd/img_29.png)  
...
![img_1.png](./images/cicd/img_1.png)  
2. 왼쪽 창 : Developer Settings > GitHub Apps  
![img_2.png](./images/cicd/img_2.png)   
3. New GitHub App 선택   
![img_3.png](./images/cicd/img_3.png)  
4. 다음 항목들을 작성 
...
6. Permissions : 권한 설정  
    * Repository permissions : 저장소 권한  
        ![img_4.png](./images/cicd/img_4.png)  
...
7. Subscribe to events : 이벤트 설정  
    ...
    * Push  
    * Repository  
    ![img_7.png](./images/cicd/img_7.png)  
8. 사용 범위를 정하고 생성을 선택  
    ![img_8.png](./images/cicd/img_8.png)  
9. 화면 상단의 버튼(generate a private key) 클릭하여 다음 섹션'인증키 생성' 과정 1-3을 생략할 수 있다. 
    ![img_9.png](./images/cicd/img_9.png)
...
3. Create GitHub App 과정에서 생성한 App 옆의 Edit 클릭   
    ![img_11.png](./images/cicd/img_11.png)  
4. Generate a private key를 선택   
    ![img_10.png](./images/cicd/img_10.png)  
5. 키 변환(for jenkins)  
...
3. Create GitHub App 과정에서 생성한 App 옆의 Edit 클릭   
    ![img_11.png](./images/cicd/img_11.png)
4. Install App 선택  
    ![img_12.png](./images/cicd/img_12.png)  
5. 설치할 곳 선택  
    ![img_13.png](./images/cicd/img_13.png)    
6. 연동할 저장소 선택  
   ![img_14.png](./images/cicd/img_14.png)  

### 1.4. 인증(계정) 추가 : In Jenkins  
**준비물**  
1. GitHub App About 정보 기록  
    ![img_16.png](./images/cicd/img_16.png)  
2. 인증 키  
...
1. Jenkins 관리 > Security > Manage Credentials  
    ![img_15.png](./images/cicd/img_15.png)  
2. 화면 상에서 (global) 클릭  
    ![img_17.png](./images/cicd/img_17.png)  
...
7. Behaviours 의 선택  
    ![img_30.png](./images/cicd/img_30.png)  
...
2. 왼쪽창에서 Application 선택  
    ![img_20.png](./images/cicd/img_20.png)  
3. App 우측의 Configure 선택  
    ![img_21.png](./images/cicd/img_21.png)  
